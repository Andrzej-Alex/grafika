...
function makeKleinFigure8ParametricSurface(radius, startAngle, section, n, a=2) {
    ...
    function f(u, v, res) {
        ...
        let x = cosu * (radius + cosnu2 * sinv - sinnu2 * sin2v / a);
        let y = sinu * (radius + cosnu2 * sinv - sinnu2 * sin2v / a);
...
function makeKleinFigure8Geometry(radius, radialSegs, heightSegs, startAngle=0, section=1, n, a) {
    let f = makeKleinFigure8ParametricSurface(radius, startAngle, section, n, a);
...
function initGui() {
    ...
    gui.add(controls, 'n', -8, 8).step(1).onChange(updateKlein);
...
function updateKlein() {
    ...
    let startAngle = 0.25;
    let section = 0.5;
    let geom = makeKleinFigure8Geometry(radius, nbrSegments, heightSegments, startAngle, section, n, a);
    ...
    // second Mobius band
    startAngle = 0.75;
    geom = makeKleinFigure8Geometry(radius, nbrSegments, heightSegments, startAngle, section, n, a);
